  ...
  return (
    <>
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Verification Criteria', url: 'https://avorria.com/verification/criteria' },
      ]} />

      <CinematicPageHero
        eyebrow="Standards Registry v2026.1"
        title="Published Verification Criteria"
        subtitle="Avorria evaluates commercial trade contractors exclusively against published, objective criteria. Every evidence benchmark, requirement classification, and review source — openly disclosed."
        backgroundImage="/images/hero-criteria.jpg"
        backgroundAlt="Structural auditing lab with blueprints and inspection documents"
        primaryCta={{ label: 'Start Verification', href: '/contractor-verification' }}
        secondaryCta={{ label: 'View Passport', href: '/contractor-passport' }}
      />
