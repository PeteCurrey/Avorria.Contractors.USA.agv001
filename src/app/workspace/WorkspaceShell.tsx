      ...
      <aside className="w-64 bg-[#090d16] border-r border-slate-800 flex flex-col justify-between shrink-0 hidden md:flex">
        <div className="space-y-6">
          ...
          <nav className="px-3 space-y-1">
            ...
            {/* Reserved Navigation Slots (Greyed-out Coming Soon) */}
            <div className="pt-4 px-3 pb-1 text-[10px] font-mono uppercase tracking-wider text-slate-600">
              EXPANSION PILLARS
            </div>

            {/* Create — Prompt 2 */}
            <div
              className="flex items-center justify-between px-3 py-2 text-xs text-slate-600 cursor-not-allowed border border-transparent"
              title="AI Document Generation Engine arriving in Prompt 2"
            >
              ...
              <span className="text-[9px] font-mono uppercase px-1.5 py-0.5 bg-slate-900 border border-slate-800 text-slate-500">
                Prompt 2
              </span>
            </div>
            ...
            <div
              className="flex items-center justify-between px-3 py-2 text-xs text-slate-600 cursor-not-allowed border border-transparent"
              title="Firebase Media & Plant Asset Search arriving in Prompt 3"
            >
              <div className="flex items-center gap-3">
                <svg className="w-4 h-4 text-slate-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
